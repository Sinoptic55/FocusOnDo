...
async def test_get_tasks():
    ...
    tasks = [
        Task(id=1, user_id=1, title="Task 1", created_at=datetime.now(), updated_at=datetime.now()),
        Task(id=2, user_id=1, title="Task 2", created_at=datetime.now(), updated_at=datetime.now())
    ]
